...
const ContactIcons = () => {
  ...
  const icons = [
    { icon: <FaEnvelope />, link: '#', color: '#39FF14', onClick: () => setShowEmailModal(true) },
    { icon: <FaLinkedin />, link: 'https://www.linkedin.com/in/aline-coatanoan/', color: '#0077B5' },
    { icon: <FaPhone />, link: '#', color: '#00FFFF', onClick: () => setShowPhoneModal(true) },
    { icon: <FaInstagram />, link: 'https://www.instagram.com/aline_coding/', color: '#FF007F' },
    { icon: <FaFacebookMessenger />, link: 'https://m.me/AlineCoding', color: '#0084FF' },
  ...
  return (
    <div id="contact" className="flex flex-col items-center justify-center h-screen text-center p-4 bg-[#1D232A]">
      ...
      {showEmailModal && (
        <div className="fixed inset-0 bg-[#227265] bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-[#1D232A] p-6 rounded-lg text-center">
            <h3 className="text-xl">Mon email</h3>
            <p className="text-lg mt-2">coatanoan.aline@outlook.com</p>
            <button 
      ...
      {showPhoneModal && (
        <div className="fixed inset-0 bg-[#227265] bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-[#1D232A] p-6 rounded-lg text-center">
            <h3 className="text-xl">Mon numéro de téléphone</h3>
            <p className="text-lg mt-2">06 11 18 85 66</p>
            <button 
              className="mt-4 px-4 py-2 bg-[#227265] text-white rounded" 
